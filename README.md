...
:star: Now with modularity and plugins! You can check the plugins folder: [/mac-cli/plugins](https://codeberg.org/martinsnygg/Mac-CLI/tree/master/mac-cli/plugins)

_Contributions to add new plugins and keep improving the existing ones are welcome and very much appreciated!_

![image](https://codeberg.org/martinsnygg/Mac-CLI/raw/master/demo/demo.gif)
...
Via curl
> `sh -c "$(curl -fsSL https://codeberg.org/martinsnygg/Mac-CLI/raw/branch/master/mac-cli/tools/install)"`

Via wget
> `sh -c "$(wget https://codeberg.org/martinsnygg/Mac-CLI/raw/branch/master/mac-cli/tools/install -O -)"`
...
> `sh -c "$(curl -fsSL https://codeberg.org/martinsnygg/Mac-CLI/raw/branch/master/mac-cli/tools/update)"`
...
> `sh -c "$(curl -fsSL https://codeberg.org/martinsnygg/Mac-CLI/raw/branch/master/mac-cli/tools/uninstall)"`
